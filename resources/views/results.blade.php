...
@if (Auth::user()->role == 1 || Auth::user()->role == 2)
	...
	<div class="container">		
		...
		<div class="row justify-content-center">
			<div class="col-md-12">				
				<div class="card">
					<div class="card-header"><b>{{ __('Academic Member Vote Results') }}</b></div>
					<div class="card-body">
						<div class="stat-holder">
							@php ($votes = 0)
							@php ($votesPercentage = 0)
		...
		<div class="row justify-content-center">
			<div class="col-md-12">				
				<div class="card">
					<div class="card-header"><b>{{ __('Administrative Member Vote Results') }}</b></div>
					<div class="card-body">
						<div class="stat-holder">
							@php ($votes = 0)
							@php ($votesPercentage = 0)
