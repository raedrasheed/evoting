				...
				<div class="card">
					...
					<div class="card-body">
                        ...
                        @csrf
							...
							<div class="form-group row">
								<label for="email" class="col-md-4 col-form-label{{(App::isLocale('ar') ? ' text-md-left' : ' text-md-right')}}">{{ __('E-Mail') }}</label>
							...
							<div class="form-group row">
								<label for="role" class="col-md-4 col-form-label{{(App::isLocale('ar') ? ' text-md-left' : ' text-md-right')}}">{{ __('User Role') }}</label>
